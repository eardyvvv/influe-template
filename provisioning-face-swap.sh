...
LORAS=(
    "https://huggingface.co/ilkerzgi/Overlay-Kontext-Dev-LoRA/resolve/main/WVVtJFD90b8SsU6EzeGkO_adapter_model_comfy_converted.safetensors"
)
...
function provisioning_start() {
    ...
    local MODELS_TOTAL=$((${#DIFFUSION_MODELS[@]} + ${#LORAS[@]} + ${#CLIP_MODELS[@]} + ${#VAE_MODELS[@]}))
